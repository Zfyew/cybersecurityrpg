...
async function loadLevel(num) {
    ...
    const params = aiMode ? `?ai_mode=true&api_key=${encodeURIComponent(apiKey)}` : '';
    ...
    modeEl.textContent = data.ai_generated
        ? '// AI MODE — scenario generated by Claude'
        : aiMode ? '// AI MODE — using cached scenario' : '// STANDARD MODE';
...
async function submitAnswer(answer) {
    ...
    if (data.correct) {
        ...
        // get Claude's take if in AI mode
        if (aiMode) {
            ...
            if (fbData.feedback) {
                ...
                aiFeedback.textContent = `Claude: ${fbData.feedback}`;
